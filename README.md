...
# NEXT_PUBLIC_***REMOVED***=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...

# Database (opzionale per Drizzle)
***REMOVED***=***REMOVED***postgres:[password]@db.[project-ref].supabase.co:5432/postgres
...
NEXT_PUBLIC_***REMOVED***=your_supabase_anon_key
***REMOVED***=your_supabase_service_role_key
...
3. **Copia:**
   - **Project URL** → `NEXT_PUBLIC_SUPABASE_URL`
   - **anon/public key** → `NEXT_PUBLIC_***REMOVED***`
   - **service_role key** → `***REMOVED***` ⚠️ **Questa chiave è segreta!**

**⚠️ IMPORTANTE**: La `***REMOVED***` ha privilegi amministrativi completi. Non condividerla mai pubblicamente e usala solo per operazioni server-side come le migrations Drizzle.
