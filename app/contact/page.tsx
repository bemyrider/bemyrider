      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Card className="border-[#ff9900]">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  ...
                  Contattaci per discutere partnership e opportunità di business.
                </p>
                <Button 
                  variant="outline" 
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Come funziona bemyrider?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  bemyrider è una piattaforma che connette rider qualificati con aziende 
                  che necessitano di servizi di consegna. I rider possono registrarsi, 
                  creare il loro profilo e ricevere richieste di lavoro.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Come posso diventare un rider?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Registrati gratuitamente, completa il tuo profilo con le tue competenze 
                  e inizia a ricevere richieste di lavoro dalle aziende partner.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Quanto tempo ci vuole per ricevere una risposta?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Cerchiamo di rispondere a tutti i messaggi entro 24 ore durante i giorni lavorativi.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Offrite supporto tecnico?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Sì, il nostro team di supporto è disponibile per aiutarti con qualsiasi 
                  problema tecnico o domanda sull'utilizzo della piattaforma.
                </p>
              </CardContent>
            </Card>
          </div>
