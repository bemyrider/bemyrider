    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Gestisci Prenotazioni</h1>
          <p className="text-gray-600">Visualizza e gestisci le tue prenotazioni rider</p>
        </div>
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                Non hai ancora effettuato prenotazioni. Cerca un rider per iniziare.
              </p>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          <strong>Inizio:</strong> {formatDateTime(booking.startTime)}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          <strong>Totale:</strong> {formatCurrency(booking.grossAmount)}
                        </span>
                      </div>
                    </div>
