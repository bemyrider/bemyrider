    ...
    <div className='max-w-4xl mx-auto p-8'>
        ...
        <Card>
          ...
          <CardContent>
            {profileInfo?.error ? (
              ...
              <div className='space-y-2 text-sm'>
                <p>
                  <strong>ID:</strong> {profileInfo.id}
                </p>
                <p>
                  <strong>Full Name:</strong> {profileInfo.full_name}
                </p>
                <p>
                  <strong>Role:</strong>{' '}
                  <span
                ...
                <p>
                  ...
                  {profileInfo.avatar_url || 'None'}
                </p>
                <p>
                  <strong>Created:</strong>{' '}
                  {new Date(profileInfo.created_at).toLocaleString()}
                </p>
                <p>
                  <strong>Updated:</strong>{' '}
                  {new Date(profileInfo.updated_at).toLocaleString()}
                </p>
      ...
      <Card className='mt-6'>
        <CardHeader>
          ...
          <CardDescription>
            Comparison between intended role and database role
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          {userInfo.user_metadata?.role !== profileInfo?.role && (
            <div className='mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded'>
              <p className='text-yellow-800'>
                ⚠️ <strong>Mismatch detected!</strong> The intended role
                doesn&apos;t match the database role.
              </p>
            </div>
          )}
        </CardContent>
