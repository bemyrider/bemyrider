    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="container mx-auto px-4 pt-32 pb-20 text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          bemyrider è la piattaforma che mette in contatto esercenti locali con rider autonomi 
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                Prenota un rider per le tue consegne in pochi click. 
                Scegli data, ora e durata del servizio.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                Ogni rider definisce la propria tariffa oraria. 
                Nessuna sorpresa, solo prezzi chiari e onesti.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                Pagamenti gestiti da Stripe con massima sicurezza. 
                Il rider riceve il pagamento direttamente sul suo account.
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">Per i Rider</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold">1</div>
                  <div>
                    <h4 className="font-semibold">Crea il tuo profilo</h4>
                    <p className="text-gray-600">Registrati e definisci la tua tariffa oraria</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Seleziona i giorni e orari in cui sei disponibile</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Accetta le richieste e guadagna</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">Per gli Esercenti</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Sfoglia i profili e le tariffe</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Completa il pagamento con carta</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-6 text-sm text-gray-400">
            <a href="https://bemyrider.it/app/privacy-policy/" target="_blank" rel="noopener noreferrer" className="hover:text-white">Privacy Policy</a>
            <a href="https://bemyrider.it/app/termini-e-condizioni-bemyrider/" target="_blank" rel="noopener noreferrer" className="hover:text-white">Termini e Condizioni</a>
