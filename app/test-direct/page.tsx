    ...
    const testDirectCalls = async () => {
      try {
        ...
        if (authError || !user) {
          ...
          setResults([
            {
              test: 'Direct Profiles',
              data: profilesData,
              error: profilesError,
            },
            {
              test: 'Direct Esercenti',
              data: esercentiData,
              error: esercentiError,
            },
            { test: 'Auth', data: user, error: authError },
            {
              test: 'Direct User Profile',
              data: userProfile,
      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='bg-green-50 border border-green-200 rounded-lg p-4 mb-6'>
          ...
          <p className='text-green-700 text-sm'>
            This test completely bypasses the Supabase JS client and PostgREST
            issues by making direct HTTP calls to the Supabase REST API. This
            should work even when PostgREST schema cache is broken.
          </p>
        </div>
