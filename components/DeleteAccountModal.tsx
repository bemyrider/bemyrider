    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
      <Card className='w-full max-w-md mx-4'>
        <CardHeader className='text-center'>
          ...
          <CardDescription>Questa azione è irreversibile</CardDescription>
        </CardHeader>
            ...
            <div className='space-y-4'>
              <div className='bg-red-50 p-4 rounded-lg border border-red-200'>
                ...
                <ul className='text-sm text-red-700 space-y-1'>
                  <li>
                    • Il tuo profilo{' '}
                    {userRole === 'merchant' ? 'aziendale' : 'rider'} sarà
                    eliminato
                  </li>
                  ...
                  {userRole === 'rider' && (
                    <li>
                      • I dati fiscali e di disponibilità saranno eliminati
                    </li>
                  )}
                  {userRole === 'merchant' && (
                    <li>• I dati aziendali e fiscali saranno eliminati</li>
                  )}
                  <li>• L&apos;accesso all&apos;account sarà revocato</li>
                  <li>
                    • <strong>Questi dati NON possono essere recuperati</strong>
                  </li>
                </ul>
              </div>
          ...
          {step === 'confirm' && (
            <div className='space-y-4'>
              <div className='text-sm text-gray-600'>
                <p className='mb-4'>
                  Per confermare l&apos;eliminazione del tuo account, digita
                  esattamente il seguente testo:
                </p>
