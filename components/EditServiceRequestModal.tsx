        ...
        <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-4'>
          <div>
            <CardTitle className='text-xl'>
              Modifica Richiesta di Servizio
            </CardTitle>
            <CardDescription>
            ...
            <div>
              ...
              <div className='relative'>
                ...
                <Input
                  ...
                  onChange={e =>
                    handleInputChange('merchant_address', e.target.value)
                  }
              ...
              <div className='text-sm space-y-1'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span>
                    ...
                    {formData.duration_hours === '1' ? 'ora' : 'ore'}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span>Indirizzo:</span>
                  <span
                    ...
                    title={formData.merchant_address}
                  >
                ...
                <div className='flex justify-between font-medium'>
                  ...
                  <span>
                    €
                    {(request.rider.riders_details?.hourly_rate || 0) *
