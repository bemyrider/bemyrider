...
- [ ] **Service Role**: `***REMOVED***` configurata correttamente
...
supabase secrets set STRIPE_WEBHOOK_SECRET=***REMOVED***... --project-ref your-prod-ref
```
...
```bash
# Restore da backup
psql $***REMOVED*** < backup-20240117.sql
```
