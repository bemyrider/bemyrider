...
# .env
USERNAME="username"
***REMOVED***="***REMOVED***${USERNAME}@localhost/my_database"
```
```js
// index.js
console.log('***REMOVED***', process.env.***REMOVED***)
```
```sh
...
```ini
# .env
***REMOVED***="***REMOVED***$(whoami)@localhost/my_database"
```
```js
// index.js
console.log('***REMOVED***', process.env.***REMOVED***)
...
***REMOVED*** ***REMOVED***yourusername@localhost/my_database
```
